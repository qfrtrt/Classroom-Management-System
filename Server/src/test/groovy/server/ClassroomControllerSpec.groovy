...
class ClassroomControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.classroomService = Mock(ClassroomService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.classroomService = Mock(ClassroomService) {
            1 * save(_ as Classroom) >> { Classroom classroom ->
                throw new ValidationException("Invalid instance", classroom.errors)
            }
        }
    ...
    void "Test the update action with an invalid instance"() {
        ...
        request.contentType = FORM_CONTENT_TYPE
        request.method = 'PUT'
        controller.update(new Classroom())
